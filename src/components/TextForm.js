...
export default function TextForm(props) {
    ...
    <div className={`container text-${props.mode==='dark'?'light':'dark'}`}>
            ...
            <div className="my-3">
                ...
                <button className="btn btn-primary my-2 mx-2" onClick={handleUpClick} >Covert To Uppercase</button>
                <button className="btn btn-primary my-2 mx-2" onClick={handleLoClick} >Covert To Lowercase</button>
                ...
                <button className="btn btn-primary my-2 mx-2" onClick={handleRemoveSpace} >Remove Extra Space</button>
